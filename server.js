...
// لیست دستورات منوی تلگرام را هر بار که سرور بالا می‌آید، خودکار ثبت کن
async function setupBotCommands() {
  ...
  try {
    ...
    // مطمئن شو دکمه‌ی کنار جعبه‌ی پیام روی حالت «نمایش دستورات» تنظیم است
    ...
    console.log("setChatMenuButton result:", JSON.stringify(menuButtonResult));

  } catch (error) {
    console.error("setMyCommands request crashed:", error);
  }
}
